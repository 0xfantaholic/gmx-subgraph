...
//   let accruedFundingRate = BigInt.fromI32(fundingRateEntity.endFundingRate).minus(position!.entryFundingRate)
...
//     userStat.timestamp = parseInt(timestampId)
...
//     user.period = period
//     user.timestamp = parseInt(timestampId)
...
//   let totalEntity = _getOrCreateGmxStat("total", "total")
//   totalEntity.distributedEsgmx = totalEntity.distributedEsgmx.plus(amount)
//   totalEntity.distributedEsgmxCumulative = totalEntity.distributedEsgmxCumulative.plus(amount)
//   totalEntity.distributedEsgmxUsd = totalEntity.distributedEsgmxUsd.plus(amountUsd)
//   totalEntity.distributedEsgmxUsdCumulative = totalEntity.distributedEsgmxUsdCumulative.plus(amountUsd)
...
//   entity.distributedEsgmx = entity.distributedEsgmx.plus(amount)
//   entity.distributedEsgmxCumulative = totalEntity.distributedEthCumulative
//   entity.distributedEsgmxUsd = entity.distributedEsgmxUsd.plus(amountUsd)
...
//   let periodTimestamp = parseInt(_getDayId(timestamp))
