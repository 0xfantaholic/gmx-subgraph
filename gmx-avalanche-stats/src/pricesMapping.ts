...
//   let ethPerGmx = event.params.amount0.times(BigInt.fromI32(10).pow(18)).div(event.params.amount1).times(BigInt.fromI32(-1)).times(BigInt.fromI32(100)).div( BigInt.fromI32(99))
